...
export class CompetitorEngine {
  ...
  constructor(options = {}) {
    ...
    this.seekingAlpha = options.seekingAlpha || new SeekingAlphaClient({ cache: this.cache, store: this.store });
   ...
   * Utilizes Cache-First -> DB-First -> Live Multilateral Crawl -> Dual Write pipeline.
